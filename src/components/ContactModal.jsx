            ...
            <div className="modal__content">
                ...
                <form className="modal__form" onSubmit={(e) => {
                    ...
                    <div className="modal__form__group">
                        <label className="modal__form__label"><span className="modal__form__label--number">01</span>Votre
                            besoin ?</label>
                    ...
                    <div className="modal__form__group">
                        <label className="modal__form__label"><span
                            className="modal__form__label--number">02</span> Budget alloué au projet</label>
                        <div className="flex modal__form__label--multi">
                            <label className="modal__form__input--container">
                                <input className="modal__form__input--radio" type="radio" name="budget"
                                       value="moins de €2k"
                    ...
                    <div className="modal__form__group">
                        <label className="modal__form__label"><span
                            className="modal__form__label--number">03</span> Votre nom</label>
                    ...
                    <div className="modal__form__group">
                        <label className="modal__form__label"><span
                            className="modal__form__label--number">04</span> Votre Email</label>
                        <div className="modal__form__input--container">
                    ...
                    <div className="modal__form__group">
                        ...
                        <div className="modal__form__input--container">
                            <textarea className="modal__form__textarea" name="projectDetails"
                    ...
                    <div className="modal__form__group">
                        <label className="modal__form__label"><span
                            className="modal__form__label--number">06</span> Quand on commence ?</label>
                        <div className="modal__form__input--container">
                            <input className="modal__form__input" type="date" name="startDate"
                    ...
                    <button className="modal__form__button modal__form__button--submit" type="submit">Envoyer une
                        demande
                    </button>
                </form>
